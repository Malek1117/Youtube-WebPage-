...
async function homePage() {
    ...
    q.value = "most popular videos in India";

    let res = await fetch(`https://youtube.googleapis.com/youtube/v3/search?part=snippet&q=most popular videos in India&key=AIzaSyBRn-8EKid_53KRl9eVR6D4iVp4UQ9g0gA&maxResults=20`);
